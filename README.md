...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/google-auth-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/google-auth-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/google-auth-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/google-auth-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/google-auth-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/google-auth-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `google-auth` can be installed with:

```
conda install google-auth
```

It is possible to list all of the versions of `google-auth` available on your platform with:
